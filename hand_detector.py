...
class HandDetector:
    def __init_ (self):
        ...
        self.imgOutput = img.copy()
        self.hands, self.img = detector.findHands(self.img)
    def run(self,running_video):
        while running_video:
            ...
            if self.hands:
                ...
                cv2.putText(self.imgOutput, "Échap pour quitter",(0,20),cv2.FONT_HERSHEY_COMPLEX, 1, (255,)*3, 2)
